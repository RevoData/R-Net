...
home = '/media/senmu/source/数据处理/nlp处理/中文阅读理解/R-Net_tensorflow'
...
glove_word_file = '/media/senmu/data_col/nlp/word_vecs/glove.840B.300d.txt'
...
flags.DEFINE_string("glove_word_file", glove_word_file,
                    "Glove word embedding source file")
...
glove_char_file = '/media/senmu/data_col/nlp/word_vecs/glove.840B.300d.char.txt'
flags.DEFINE_string("glove_char_file", glove_char_file,
                    "Glove character embedding source file")
flags.DEFINE_boolean("pretrained_char", False,
                     "Whether to use pretrained character embedding")

fasttext_file = ''
flags.DEFINE_string("fasttext_file", fasttext_file,
                    "Fasttext word embedding source file")
